...
ActiveRecord::Schema[7.1].define(version: 2026_07_24_110000) do
  ...
  create_table "crm_public_pool_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "recycle_days_key_account_won"
    t.integer "recycle_days_won"
  ...
  create_table "mes_bom_items", force: :cascade do |t|
    ...
    t.string "specification"
    t.string "category", default: "MACHINE", null: false
  ...
  create_table "mes_shipments", force: :cascade do |t|
    ...
    t.index ["manager_id"], name: "index_mes_shipments_on_manager_id"
  ...
  add_foreign_key "mes_shipments", "users", column: "manager_id", on_delete: :nullify
