...
<template>
  <component
    ...
    class="flex items-center gap-3 px-3 h-11 rounded-xl min-w-0 transition-colors"
    role="button"
    draggable="false"
    :to="to"
    :title="label"
    :class="{
      'text-white bg-gradient-to-r from-n-iris-9 to-n-iris-10 font-medium shadow-sm shadow-n-iris-9/30':
